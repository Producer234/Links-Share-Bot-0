...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "close":
        ...
        await query.edit_message_media(
            InputMediaPhoto(START_PIC, 
                            CHANNELS_TXT
            ),
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton('🔥 ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ', url='https://t.me/PR_ALL_BOT')],
                [InlineKeyboardButton('🎯 ᴘʀ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ', url='https://t.me/MAIN_CHANNEL_PR')],
                [InlineKeyboardButton('💎 ʜᴀʀᴇᴍ ʀᴇᴀʟᴍ', url='https://t.me/Harem_realm')],
                [InlineKeyboardButton('💬 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/PR_ALL_BOT_SUPPORT')],
                [InlineKeyboardButton('• ʙᴀᴄᴋ', callback_data='start'), InlineKeyboardButton('ᴄʟᴏsᴇ •', callback_data='close')]
            ]),
        )
